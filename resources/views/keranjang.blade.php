            ...
            <div class="col-lg-6 col-12 d-flex justify-content-center ">
              <div class="row ps-2 pe-2">     
                <div class="col-lg-8 pt-4 d-flex flex-row">
                  <a href="{{ route('getSeller', ['id' => $dk->produk->user->nama_toko]) }}" class="text-decoration-none pb-2 custom-link"><h3 class="font-weight-bold">{{$dk->produk->user->nama_toko}} </h3></a>
                </div>
                @foreach($data as $dx)
